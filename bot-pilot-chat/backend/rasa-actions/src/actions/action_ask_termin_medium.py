...
class ActionAskTerminMedium(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if attempts == 0:
            message = ('Welchen Medien wollen Sie benutzen, um Ihnen einen '
        ...
        if 3 > attempts > 0:
            message = ('Es tut mir leid, ich konnte leider nicht verstehen, '
            ...
            fail_message = ('Es tut mir leid, dass ich Ihre Anfrage gerade '
